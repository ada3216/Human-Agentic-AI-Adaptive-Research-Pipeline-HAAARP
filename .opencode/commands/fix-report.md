...
Commit exemption: read-only exempt. This command produces diagnostic output only, writes no governed files, and does not need a workflow-end commit or a clean git commit.
